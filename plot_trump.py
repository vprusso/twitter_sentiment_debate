...
fig = plt.figure()
fig.canvas.set_window_title('Trump tweet sentiment')

plt.title('Trump tweet sentiment')
plt.suptitle('Trump tweet sentiment')
...
def animate(i):
    pull_data = open("trump_tweets.txt", "r").read()
